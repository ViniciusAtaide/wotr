...
---
# Feats — Magic Feats
*34 feats. Source: GameFAQs WotR Guide (80843).*

## Ambuscading Spells
Flat-footed opponents receive a -2 penalty on saving throws against spells you cast.

## Arcane Spirit
As a swift action, attempt a Persuasion (Bluff) check against a creature within 30'. The check is made against the target's Perception and if it successful, they receive a -2 penalty to saving throws against the next spell that you cast.
...
**Prereq:** Combat Casting, Skill Focus - Mobility
...
Level Increase: +1
A bolstered spell deals 2 more points of damage per die to all targets. All enemies within 5' of the spell targets receive 2 damage per die.
...
Level Increase: +1
When casting a selective spell with an area of effect, you can choose a number of targets equal to your casting attribute modifier to exclude from the effects of the spell.
This feat is supposed to work only with instantaneous spells such as *Fireball*. However, it appears to work with any AoE spell including potent disablers like *Grease* and *Sirocco*.
...
## Spell Focus
Choose a school of magic and add +1 to the Difficulty Class for all saves against spells from the selected school of magic.
Abjuration and Divination spells don't really come with saving throws but you may want to take Spell Focus (Abjuration) so that you can select Greater Dispel Magic with Spell Specialization.

## Greater Spell Focus
**Prereq:** Spell Focus (any)
...
When you cast a summoning spell which conjures more than one creature, an additional creature of the same type will be summoned.

## Spell Penetration
Adds +2 to caster level checks to overcome a creature's spell resistance.
...
## Dispel Focus
When making a dispel attempt, add +2 to your effective caster level.

## Dispel Synergy
If you successfully dispel a magical effect on an opponent, that opponent takes a -2 penalty to saves against your spells for 1 round.

## Greater Dispel Focus
**Prereq:** Dispel Focus
When making a dispel attempt, add an additional +2 to your effective caster level.

## Brew Potions
You can brew potions of spells up to level 3 while camping.

## Scribe Scrolls
You can craft scrolls while camping.
