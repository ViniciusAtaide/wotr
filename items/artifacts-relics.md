...
- Generosity: the wearer gains the effect of the *Frightful Aspect* spell
- Humility: the wearer gains the effect of the *Blur* spell and a +4 insight bonus to all skill checks
- Temperance: the wearer gains the effect of the *False Life (Greater)* spell and +2 bonus to saves vs. death effects
- Love: the wearer gains the effect of the *Greater Heroism* spell
- Charity: the wearer gains the effect of the *Mind Blank* spell
- Zeal: the wearer gains the effect of the *Seamantle* spell
- Kindness: the wearer gains the effect of the *Winds of Vengeance* spell
...
- Blackwing Library
In a chest in the secret room.
- Gray Garrison
In a trash pile on the first floor.
- Gray Garrison
In a storeroom on the first floor.
- Gray Garrison
In a room on the second floor.
- Nightingale Grove
In a container in the marauders camp.
- Reliable Redoubt
In a crate in the Hellknights' camp.
- Underground Hideout
In a loot stash just off the path to the hideout.
- Drezen Prison
In the secret room accessed from the ruins.
- Drezen Barracks
In a barrel by the entrance.
- Temple of the Good Hunt
In a crate in a storeroom.
- Ashen Grotto
In the cave with Thraz the Spinebreaker.
- Shrine of Sacrilege
On a body in the Gormandizer's lair. Requires a Perception (30) check.
- Molten Scar
On a body in a cage. Requires a Perception (25) check.
- Areelu's Lab (Old Wing)
On a shelf in the room with the magic barrier across a doorway.
- Midnight Fane
In a wardrobe on the lower floor.
- Lower City
In a chest on a rooftop accessible using Dimension Door.
- Nexus Caves
On a body in the Camouflaged Tunnel.
- Drezen (Chapter 5)
In the fireplace of the Half-Measure Tavern.
- Bladesmith's Workshop
In a cauldron in the main room.

### Cold Iron Locations
- Moondance Meadow
On a dead body.
- Lost Chapel
In the Gargoyle Lair.
- Drezen Citadel
In Joran Vhane's forge.
- Greengates
In an urn in a room with demons.
- Ivory Sanctum
In a chest in the room with the mimics.
- Ravaged Longhouse
On a dead body in the cave section.
- Areelu's Lab
In the room with the Tortured Angel.
- Bad Luck Tavern
In a locked chest in a trapped room.
- Upper City
In a locked chest north of the portal from the Middle City.
- Hidden Abode
In a chest in the back room.
- Drezen (Chapter 5)
in a grave in the graveyard.
- Drezen (Chapter 5)
Under a tarpaulin in the temple.

### Demon Blood Locations
- Shrine of Sacrilege
In the Gormandizer's lair.
- Artisan's Tower
On a shelf.
- Ivory Sanctum
In a chest in the room where you first meet Xanthir Vang.
- Ivory Sanctum
Among some discarded trophies in a corridor.
- Hellknights Outpost
In a locked chest inside the keep.
- Legacy of the Ancients
In a vase.
- Nexus Caves
In a crate just past the portal back to the Midnight Fane.
- Lower City
In a chest accessible by rotating the camera to create a path.
- Upper City
In a cabinet in a building near the chest containing Cold Iron.
- Jubilost Encounter
...
## Relics
Most Relics are found in demon lairs during crusade mode, although you will also find two in Alushinyrra in Chapter 4. After recovering a relic, you can issue a decree to study it (5 days, 1000 Finance Points, 100 Material Points) after which you can choose what sort of magic item you want to turn it into (5 days, 500 Finance Points, 50 Material Points, 50 Energy Points).
...
### The Dirty Squealer
- Amulet**Embrace of the Faceless**
...
- Heavy Flail**Triumphant Noontide**
