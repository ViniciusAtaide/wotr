# Wizard / Sorcerer Spells — Level 0
...
- **Disrupt Undead** *(Necromancy)* — T: One enemy creature within close range | SR — Your successful ranged touch attack does 1d6 points of energy damage to a single undead creature.
- **Flare** *(Evocation)* — T: One enemy creature within close range | Dur: 1 minute | Save: Fortitude negates | SR — The target is dazzled for 1 minute unless it makes a successful Fortitude save.
