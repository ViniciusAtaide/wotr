...
- **Summon Nature's Ally VI** *(Conjuration)* — T: Target point within close range | Dur: 1 round / level | Desc: Summoning | Cast: Full round — Summon a smilodon, 1d3 manticores or 1d4+1 dire boars.
- **Tar Pool** *(Transmutation)* — _See Wizard spell list._
